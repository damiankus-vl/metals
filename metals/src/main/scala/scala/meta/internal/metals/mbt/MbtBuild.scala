...
case class MbtBuild(
  ...
  /**
   * Declared class output locations (jars or directories) across all
   * targets, resolved against the workspace. Makes compiled-only members
   * navigable, e.g. ones generated by annotation processors that
   * source-only tools can't see.
   */
   ...
   * resolving annotation-processor-generated members for the target being
   * edited.
   */
